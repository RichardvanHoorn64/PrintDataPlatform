...
class DownloadProducerOffer(LoginRequiredMixin, View):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        printproject_paper_description_cover = printproject_paper(printproject.papercategory_cover, printproject.paperbrand_cover,
                                                                  printproject.paperweight_cover, printproject.papercolor_cover)
        ...
        document.merge(
            ...
            # finance
            aanbieding=str(printproject_salesprice(printproject)),
            duizend_meer=str(printproject_salesprice1000extra(printproject)),
...
class DownloadProducerOffer_dev(LoginRequiredMixin, View):
