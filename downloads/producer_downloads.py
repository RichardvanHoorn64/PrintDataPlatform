...
class ProducerDownloadOffers(LoginRequiredMixin, View):
    def get(self, request):
        ...
        return FileResponse(buffer, as_attachment=True,
                            filename='PrintDataHubData ' + producer_company + " " + str(export_datum) + '.xlsx')
...
class ProducerDownloadOrders(LoginRequiredMixin, View):
    def get(self, request):
        ...
        # worksheet orders
        worksheet_printprojects = workbook.add_worksheet(worksheet_name_orders + str(export_datum))
        ...
        # worksheet offers
        worksheet_offers = workbook.add_worksheet(worksheet_name_orders + str(export_datum))
